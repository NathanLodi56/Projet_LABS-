...
{
  public static $slug = 'témoignage_details_metabox';
  /**
   ...
   * @return void
   */
  public static function add_meta_box_testi()
  {
    $screen = [TestimonialPostType::$slug];
    add_meta_box(
      self::$slug,           // Unique ID
      __("profession de la personne qui témoigne"),  // Box title
  ...
  public static function render()
  {
    ...
    view('metaboxes/testimonial-detail');
  }
  ...
  public static function save($post_id)
  {
    ...
    if (count($_POST) != 0) {
      ...
      $profession = $_POST['nom_testi'];
      // https://developer.wordpress.org/reference/functions/update_post_meta/
      update_post_meta($post_id, 'nom_testi', $profession);
    }
  }
